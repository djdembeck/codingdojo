...
ActiveRecord::Schema.define(version: 20210611165022) do
  ...
  add_index "comments", ["comentable_type", "comentable_id"], name: "index_comments_on_comentable_type_and_comentable_id"
